...
import fs from "fs";
import { controllerWebsiteLinks } from "../helpers/controller-website-links.js";
...
export async function scrapeControllerHeliController(req, res) {
  try {
    const results = [];
    ...
    fs.writeFileSync(
      "./scraped-data/controllerHeli-results.json",
